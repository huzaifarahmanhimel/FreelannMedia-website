    ...
    <section className="relative bg-black text-white overflow-hidden">
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        ...
        <div className="pointer-events-none absolute left-1 sm:left-6 top-4 sm:top-10 flex flex-col gap-4">
          <FloatingBadge text="Podcast Editing" delay={0} />
          <div className="flex items-center gap-3 pl-1">
            ...
            <FloatingBadge text="Ad Creatives & VSL" delay={0.15} small />
            <GlowArrow delay={0.2} />
          </div>
        </div>
        ...
        <div className="pointer-events-none absolute right-1 sm:right-6 top-6 sm:top-12 flex flex-col gap-4 items-end">
          <div className="flex items-center gap-3 pr-1">
            ...
            <FloatingBadge text="Short Form Content" delay={0.45} />
          </div>
          <div className="flex items-center gap-3">
            <FloatingBadge text="Youtube Videos" delay={0.55} />
        ...
        <div className="relative pt-24 sm:pt-28 md:pt-32">
          ...
          >
            ...
            <br className="hidden sm:block" />
            <span className="text-white/70">the game with us!</span>
          </motion.h2>
...
function FloatingBadge({ text, delay = 0, small = false }) {
  return (
    <motion.div
      ...
      className={`rounded-xl shadow-[0_0_40px_rgba(99,102,241,0.45)] bg-indigo-600 px-3 sm:px-4 ${small ? "py-1" : "py-1.5"} text-[12px] sm:text-sm font-semibold whitespace-nowrap`}
      style={{ filter: "drop-shadow(0 8px 20px rgba(99,102,241,0.35))" }}
    >
      {text}
    </motion.div>
  );
...
function GlowArrow({ delay = 0 }) {
  return (
    <motion.div
      ...
      className="w-6 h-6 rounded-full bg-indigo-500/70 blur-[2px]"
